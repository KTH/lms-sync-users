...
module.exports = {
  ...
  addDescription(msg) {
    ...
    const isTeacherRegExp =
      /edu\.courses\.\w{2,3}\.\w{6}\.\d{5}\.\d\.\bteachers\b/;
    const isAssistantsRegExp =
      /edu\.courses\.\w{2,3}\.\w{6,7}\.\d{5}\.\d\.\bassistants\b/;
    const isCourseResponsibleRegExp =
      /edu\.courses\.\w{2,3}\.\w{6}\.\d{5}\.\d\.\bcourseresponsible\b/;
    const isStudentsRegExp =
      /ladok2\.kurser.\w{2,3}\.\w{4}.registrerade_\d{5}\.\d/;
